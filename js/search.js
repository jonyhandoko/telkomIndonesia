...
//   	$('#header-search-input').jsonSuggest({data: testData.category, onSelect: function(item) {
// 			var getUrl = item.url;
// 		    if(getUrl != '#') {
// 		      location.href = '/telkom/' + getUrl;
// 		    }	
//   		}
//   	});
...
$(document).ready(function() {
	...
	var storeHostUrl = $("#storeHostUrl").text(); // need <var> hidden element in header div like <div class="hide" id="storeHostUrl">${storeHostUrl}</div>
